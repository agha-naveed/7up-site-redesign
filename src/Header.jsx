...
export default function Header() {
  return (
    <SmoothScroll>
      <div data-scroll data-scroll-speed="2" className='min-h-screen header-content flex justify-center pointer-events-none relative'>
          <div className="container flex justify-around items-center">
            <div className="header-content-texts py-56 w-fit z-10" data-aos="fade-up-right" data-aos-duration="1000" data-aos-easing="ease-in-out" >
                ...
                <p className='text-white text-heading-lg relative -top-10'>to be you</p>
            </div>
